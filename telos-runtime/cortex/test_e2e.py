...
def main():
    ...
    try:
        ...
        print("      [PASS] Connected to Cortex on port 50052")
    ...
    try:
        ...
        print(f"      [PASS] Registered! Allowed: {verdict.allowed}")
    ...
    try:
        ...
        if result.returncode == 0:
            print(f"      [PASS] Command succeeded: {result.stdout.decode().strip()}")
        else:
    ...
    try:
        ...
        print(f"      [PASS] Taint injected! Success: {ack.success}")
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"      [PASS] Command BLOCKED! Return code: {result.returncode}")
            print(f"        Stderr: {result.stderr.decode().strip()}")
    except PermissionError as e:
        print(f"      [PASS] BLOCKED by LSM! PermissionError: {e}")
    except subprocess.SubprocessError as e:
        print(f"      [PASS] BLOCKED! SubprocessError: {e}")
    except Exception as e:
