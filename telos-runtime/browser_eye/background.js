...
function connectToNativeHost() {
    try {
        ...
        nativePort.onMessage.addListener((msg) => {
            ...
            if (msg.type === 'ack') {
                console.log('[Telos] [PASS] Taint report acknowledged');
        ...
        nativePort.onDisconnect.addListener(() => {
            ...
            console.warn(`[Telos] [WARN] Native Host disconnected: ${error}`);
            nativePort = null;
            ...
            if (reconnectAttempts < MAX_RECONNECT_ATTEMPTS) {
                ...
                console.error('[Telos] [FAIL] Max reconnection attempts reached. Native Host unavailable.');
            }
        });
