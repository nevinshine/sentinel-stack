...
@.str = private unnamed_addr constant [35 x i8] c"purpose: SpatialBufferManipulation\00", align 1
...
define dso_local signext i32 @main() #0 {
  ...
  call void @llvm.telos.intent.start(ptr noundef @.str) #3
...
define dso_local void @tca_set_intent(ptr noundef %0, i64 noundef %1) #0 {
  ...
  call void asm sideeffect ".insn r 0x0B, 0x0, 0x01, x0, $0, $1", "r,r"(ptr %5, i64 %6) #4, !srcloc !11
  ret void
}

; Function Attrs: noinline nounwind optnone
define dso_local void @tca_clear() #0 {
  call void asm sideeffect ".insn r 0x0B, 0x0, 0x02, x0, x0, x0", ""() #4, !srcloc !12
  ret void
}
...
!8 = !{!"clang version 21.1.8 (Fedora 21.1.8-4.fc43)"}
!9 = distinct !{!9, !10}
