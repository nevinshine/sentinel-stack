...
define dso_local signext i32 @main() #0 {
  ...
  %23 = call ptr addrspace(200) @tca_set_intent(ptr addrspace(200) addrspacecast (ptr @main to ptr addrspace(200)), i64 %tca_got_load)
  %24 = call i64 @rdcycle() #3
  store i64 %24, ptr %8, align 8
  %25 = load ptr, ptr %2, align 8
  store volatile i64 -2401053089206453570, ptr %25, align 8
  %26 = call i64 @rdcycle() #3
  ...
  call void @tca_clear()
  %30 = call i64 @rdcycle() #3
  store i64 %30, ptr %11, align 8
  call void @simulate_ebpf_lsm_hook() #3
  %31 = load ptr, ptr %3, align 8
  store volatile i64 -3819410105021120785, ptr %31, align 8
  %32 = call i64 @rdcycle() #3
  ...
  call void @uart_u64(i64 noundef %38) #3
  call void @uart_puts(ptr noundef @.str.5) #3
...
42:                                               ; preds = %0
  ...
  %45 = sub i64 %43, %44
  call void @uart_u64(i64 noundef %45) #3
  br label %47
...
51:                                               ; preds = %47
  ...
  %54 = sub i64 %52, %53
  call void @uart_u64(i64 noundef %54) #3
  br label %56
