; ModuleID = 'os_isolation_test_riscv.ll'
...
@.tca_got_table = constant [2 x i64] [i64 -8526495043115022390, i64 -8526495043115022390], section ".tca_got", align 8
...
define dso_local void @thread_b_func() #0 {
  ...
  %2 = call ptr addrspace(200) @tca_set_intent(ptr addrspace(200) addrspacecast (ptr @thread_b_func to ptr addrspace(200)), i64 %tca_got_load)
...
define dso_local void @_start() #0 {
  ...
  %tca_got_load = load volatile i64, ptr getelementptr ([2 x i64], ptr @.tca_got_table, i32 0, i32 1), align 8
  %7 = call ptr addrspace(200) @tca_set_intent(ptr addrspace(200) addrspacecast (ptr @_start to ptr addrspace(200)), i64 %tca_got_load)
  ...
  store i64 ptrtoint (ptr @thread_b_func to i64), ptr %11, align 8
  %12 = load ptr, ptr %2, align 8
  %13 = getelementptr inbounds i64, ptr %12, i64 13
  ...
  store i64 %17, ptr @thread_b, align 8
  ...
  store volatile i64 1, ptr %21, align 8
